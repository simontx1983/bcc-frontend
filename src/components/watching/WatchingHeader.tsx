 ...
 *
 * Data comes pre-shaped from `GET /me/watching/summary` per §A2/§L5 —
 ...
 * once data arrives.
 *
 * Renamed from `BinderHeader` 2026-05-13 per the §1.1.1 additive-
...
import type {
  WatchingMonthlyActivity,
  WatchingSummaryResponse,
  WatchingTierDistribution,
} from "@/lib/api/types";
...
function TierDistribution({
  ...
  distribution: WatchingTierDistribution | undefined;
}) {
...
function MonthlyActivity({
  ...
  activity: WatchingMonthlyActivity | undefined;
}) {
