/**
 * /halls/[slug]/opengraph-image — branded OG card for a Hall detail page.
 *
 ...
 *
 * A Hall is a semantic wrapper over a PeepSo group; the same
 * `GET /bcc/v1/groups/{slug}` view-model powers the card (the group's
 * `type` is "hall", which the mapper reads as the "CHAIN HALL" rail). We
 * fetch the group anonymously (the crawler's public view with a null token)
 * and render via the shared group → OgCardData mapping.
 *
...
export const alt = "Blue Collar Crypto hall file";
