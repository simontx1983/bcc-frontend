/**
 * /communities/[slug]/twitter-image — Twitter card image.
 *
 * Re-exports the generated community card from opengraph-image.tsx so the
 * `twitter:image` tag points at the identical branded PNG. Single source
 * means layout / palette changes land on both surfaces at once. Next's
